namespace _02_corruption_checksum
{
    using System;
    ...
    class Program
    {
        ...
        {
            int[,] content = new int[16,16] { {121, 59, 141, 21, 120, 67, 58, 49, 22, 46, 56, 112, 53, 111, 104, 130}, 
                                            {1926, 1910, 760, 2055, 28, 2242, 146, 1485, 163, 976, 1842, 1982, 137, 1378, 162, 789}, 
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                for (int j = 0; j < 16; j++)
                {
                    for (int k = 0; k < 16; k++)
                    {
                        firstNumber = content[i,j];
                        secondNumber = content[i,k];
                        ...
                        if (secondNumber % firstNumber == 0 && firstNumber != secondNumber)
                        {
